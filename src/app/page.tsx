...
//         A platform for companies to request tasks from candidates and verify the authenticity of their submissions using blockchain technology, ensuring no plagiarism and clear tracking of work.
//       </p>
//       <SearchSection />
//     </div>
...
//     <StatCard icon="users" number="2K +" label="People Got Hired" />
    ...
    <div className="max-w-7xl mx-auto px-4">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
        <div className="p-6 bg-white rounded-lg shadow-lg">
          ...
          <p>Ensure authenticity of task submissions with blockchain tracking, ensuring transparency.</p>
        </div>
        <div className="p-6 bg-white rounded-lg shadow-lg">
          <h3 className="text-2xl font-semibold mb-4">Easy Task Management</h3>
          <p>Companies can easily manage and review candidates' task submissions with a user-friendly dashboard.</p>
        </div>
        <div className="p-6 bg-white rounded-lg shadow-lg">
          <h3 className="text-2xl font-semibold mb-4">Plagiarism Protection</h3>
          <p>Ensure no plagiarism with unique tracking of each submission on the platform.</p>
        </div>
      </div>
    </div>
  </div>
